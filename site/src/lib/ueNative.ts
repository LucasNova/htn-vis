...
const NODE_TITLE_RU: Record<string, string> = {
  ...
  "Set fire movement pace": "Темп движения",
  ...
  "Set close-fight pace": "Темп отхода к укрытию",
  ...
  "Set aiming movement pace": "Темп сближения",
  ...
  "Темп отхода к укрытию": "Темп отхода к укрытию",
  "Темп движения под подавлением": "Темп движения под подавлением",
...
const TASK_TITLE_RU: Record<string, string> = {
  ...
  "task.SetGaitWalk": "Перейти на шаг",
  "task.SetGaitJog": "Перейти на легкий бег",
  "task.SetGaitSprint": "Перейти на спринт",
...
const TASK_BODY_RU: Record<string, string> = {
  ...
  "task.SetGaitWalk": "Медленное движение для патруля, тишины или точного позиционирования; не является подготовкой к стрельбе.",
  "task.SetGaitJog": "Обычный тактический перебег между точками или укрытиями. Если начался огонь, animation/weapon component сам замедлит движение.",
  "task.SetGaitSprint": "Самое быстрое перемещение, когда агент не планирует стрелять в ближайшее окно.",
...
const DECORATOR_LABEL_RU: Record<string, string> = {
  ...
  "decorator.NotSprintingForFire": "не спринтит",
